resource "oci_devops_build_pipeline_stage" "frontend_build_pipeline_build_stage" {
  build_pipeline_id = oci_devops_build_pipeline.uho_build_pipeline["frontend"].id
  build_pipeline_stage_predecessor_collection {
    items {
      id = oci_devops_build_pipeline.uho_build_pipeline["frontend"].id
    }
  }
  ...
  depends_on                         = [oci_devops_build_pipeline.uho_build_pipeline["frontend"]]
}
