resource "oci_devops_build_pipeline_stage" "followup_build_pipeline_build_stage" {
  ...
  build_pipeline_stage_predecessor_collection {
    items {
      id = oci_devops_build_pipeline_stage.feedback_build_stage_trigger_deploy_pipeline.id
    }
  }
  ...
  depends_on                         = [oci_devops_build_pipeline_stage.feedback_build_stage_trigger_deploy_pipeline]
}
