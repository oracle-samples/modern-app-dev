...
public class PatientAppointmentNotificationTemplate extends AbstractNotificationTemplate {
  ...
  public String getMessage(String patientName, String doctorName, String status, String startTime, String endTime) {
    ...
    sb.append("Here is your appointment detail with doctor ").append(doctorName).append(";");
    sb.append("<br>").append("<br>");
