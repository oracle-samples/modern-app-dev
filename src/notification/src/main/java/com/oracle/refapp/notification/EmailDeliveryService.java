...
public class EmailDeliveryService {
    ...
    public void sendEncounterPdfEmail(
        ...
        emailSender.send(Email.builder()
                ...
                .body(new TemplateBody<>(HTML,
                        new ModelAndView<>("encounter", singletonMap("name", patientName))))
                .attachment(Attachment.builder()
                        .filename(pdfName)
                        .contentType(APPLICATION_PDF)
                        .content(pdfFileStream)
                        .build()));
    }
    ...
    public void sendAppointmentBookedEmail(
        ...
        emailSender.send(Email.builder()
                ...
                .body(new TemplateBody<>(HTML,
                        new ModelAndView<>("appointment_patient",
                                Map.of(
                                        "patientName", patientName,
                                        "providerName", providerName,
                                        "date", DateUtils.getDate(startTime),
                                        "slot", DateUtils.getTime(startTime) + " - " + DateUtils.getTime(endTime),
                                        "status", status)
                        ))));
        ...
        emailSender.send(Email.builder()
                ...
                .subject("Appointment Request Notification")
                .body(new TemplateBody<>(HTML,
                        new ModelAndView<>("appointment_provider",
                                Map.of(
                                        "patientName", patientName,
                                        "providerName", providerName,
                                        "date", DateUtils.getDate(startTime),
    ...
    public void sendFeedbackFollowupEmail(String emailSubject, String emailBody, String patientEmail) {
        emailSender.send(Email.builder()
                ...
                .body(new StringBody(emailBody, HTML)));
    }
}
